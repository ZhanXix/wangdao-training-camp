...
int main()
{
    ...
    printf(" remove file 删除服务器上当前目录的文件file\n");
    printf(" mkdir dir 在当前目录添加文件夹dir\n");
    printf(" rmdir dir 在当前目录删除文件夹dir\n");
    ...
    {   
        ...
        if(strcmp(fileData.dataBuf,"cd")==0)//cd
        {
        ...
        }else if(strcmp(fileData.dataBuf,"rmdir")==0){
            SEND_FILEDATA;
            ret=SEND_RMDIR(socketFd,buf,i);
            if(-1==ret)
            {
                break;
            }
            ...
            printf(" remove file 删除服务器上当前目录的文件file\n");
            printf(" mkdir dir 在当前目录添加文件夹dir\n");
            printf(" rmdir dir 在当前目录删除文件夹dir（文件夹需要为空）\n");
            printf(" help 显示帮助信息\n");
            printf(" exit 退出\n");
